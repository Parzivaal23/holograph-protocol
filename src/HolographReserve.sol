...
import "./interface/HolographReserveInterface.sol";
...
/**
 * @title Holograph Reserve
 * @author https://github.com/holographxyz
 * @notice This contract holds and manages the protocol reserve
 * @dev As of now this is an empty zero logic contract and is still a work in progress
 */
contract HolographReserve is Admin, Initializable, HolographReserveInterface {
  /**
